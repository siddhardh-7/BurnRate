...
|---|---|
| **Burn Rate Live** | Real-time $/min by service and agent — your cost vital sign |
| **Cost by Agent & Task** | Which agent is spending what, on which tasks |
| **Model Efficiency** | Cost per successful task completion — spot wasteful model choices |
...
3. **Reports** — structured Slack incident report with dollar impact and recommended actions
